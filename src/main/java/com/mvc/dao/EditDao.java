...
public class EditDao 
{
    public String checkUpdate(EditBean editBean)
    {
        ...
        String owner_up=editBean.getOwner_UP(); 
        //get all value through editBean object and store in temporary variable
        int hidden_id=editBean.getHidden_ID();
        
        String url="jdbc:mysql://localhost:3306/JSP"; //database connection url string
